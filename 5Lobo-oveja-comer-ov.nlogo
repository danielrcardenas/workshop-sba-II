...
ovejas-own [energia]
lobos-own [energia]
;; Incializar el procedimiento de configuración del modelo
to setup
  clear-all
...
to comer-oveja ;; procedimiento para capturar y eliminar una oveja
  if any? ovejas-here [ ;; Preguntar por agentes tipo oveja al rededor del lobo
    let objetivo one-of ovejas-here ;; seleccionar una de las ovejas para convertirla su objetivo
    ask objetivo[
      die ;; eliminar oveja
    ]
    set energia energia + energia-de-oveja ;; actualizar energía del lobo
  ]
end

to reproducir ;; Procedimiento para generar una copia de agentes
  if energia > 200 [
    set energia energia - 100
    hatch 1 [ set energia 100]
  ]
end
