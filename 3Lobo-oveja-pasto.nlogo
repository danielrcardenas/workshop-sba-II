...
to crecer-pasto
  ask patches[
  set monto-pasto monto-pasto + razon-crecimiento-pasto ;; actualizar el monto de pasto de acuerdo a la razon de crecimiento
  if monto-pasto > 10 [;; Establecer el monto máximo de crecimiento
    set monto-pasto 10
  ]
  dibujar-pasto ;; Actualizar los colores en los patches que representan el pasto
  ]
end
to dibujar-pasto
  set pcolor scale-color green monto-pasto 0 20 ;; Crea una escala de colores verdes de acuerdo al monto de pasto en ese patch
end
