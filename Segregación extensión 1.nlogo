globals [
  ...
  colores                    ;; lista de colores que pueden tomar las tortugas
]
...
to setup
  clear-all
  ;; Se establece una lista de colores que pueden tomar las tortugas
  set colores [ red green yellow blue orange ]
  ask n-of numero patches [
    sprout 1
  ]
  ask turtles [
    ;; Se distribuye aleatóriamente a partir del número de grupos
    ;; ¿De qué otra forma se podría asignar el color?
